  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.4 }}
        className="text-3xl font-serif font-bold text-amber-800 mb-8 border-b border-amber-300 pb-4 flex items-center justify-between"
      >
        <span>Today's Culinary Inspiration</span>
        <motion.button
          whileHover={{ scale: 1.05, rotate: 5 }}
          whileTap={{ scale: 0.95 }}
          onClick={fetchRandomMeal}
          className="text-base bg-gradient-to-r from-amber-400 to-orange-400 hover:from-amber-500 hover:to-orange-500 text-white px-4 py-2 rounded-full shadow-md flex items-center font-normal"
        >
          <svg
            ...
            >
              {meal.strYoutube && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => openModal(meal.strYoutube)}
